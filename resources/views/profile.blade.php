...
<meta charset="utf-8">
        ...
        <style>
			...
			div.Introduction
			{
				...
				div.Wallpaper
				{
					height:50%; width:100%; background-image: url("339.png"); background-repeat: no-repeat; background-size: 100% 100%; border: 5px; border-color: #c8bfe7; border-style:solid; border-radius: 2px;
				}
				div.ProfilePic
				{
					height:30%; width:15%;background-image: url("aaaaa.jpg"); background-repeat: no-repeat; background-size: 100% 100%; position: absolute; top: 240px; left: 20px; border: 6px; border-color: #c8bfe7; border-style:solid; border-radius: 8px;
				}
				div.Username
				{
